...
import logo from './assets/images/TCSLOGO-colour-100ppi.png'
import smallLogo from './assets/images/TCSLOGO-colour-100ppi@1x.png'
import largeLogo from './assets/images/TCSLOGO-colour-100ppi@2x.png'
                        ...
                        <ul className="nav navbar-nav">
                            <li className="nav-item dropdown">
                                ...
                                <div className="dropdown-menu" role="menu">
                                    ...
                                    : <Link to="/" className="dropdown-item" role="presentation">My Assessments</Link>}
                                </div>
                            </li>
                    ...
                    <nav className="navbar navbar-dark navbar-expand-md navigation-clean-search">
                        <div className="container">
                            <Link to="/" className="navbar-brand" onClick={handleLogo}>               
                                <img id="TCSLOGO-colour-100ppi" alt="" src={logo} srcSet={`${smallLogo} 1x, ${largeLogo} 2x`} />
                            </Link>
