...
const userCtrl = {
    ...
    activateEmail: async (req, res) => {
        try {
            ...
            res.json({msg: "Congratulations! Your Account has been Activated. Please Log In to continue."})
    ...
    submitAssessment: async (req, res) => {
        try {
            const {questionTitle, option1, option2, option3, option4} = req.body

            await Users.findOneAndUpdate({_id: req.user.id}, {
                $push: {assessment_questions: {questionTitle, option1, option2, option3, option4}}
            })

            res.json({msg: "Your Assessment Question has been recorded."})
    ...
    updateAssessment: async (req, res) => {
        try {
            ...
            await Users.findOneAndUpdate({_id: req.user.id}, {
                assessment_questions: {questionTitle, option1, option2, option3, option4}
            })
    ...
    deleteAssessment: async (req, res) => {
        try {
            ...
            await Users.findOneAndUpdate({_id: req.user.id}, {
                $pull: {assessment_questions: {_id : questionid}}
            })

            res.json({msg: "Your Assessment Question has been deleted."})
